        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <input 
              ...
              className="bg-bg-primary/80 border border-white/20 rounded-lg px-3 py-1.5 text-xs text-text-primary focus:outline-none focus:border-neon-500/50 [color-scheme:light_dark]"
            />
          </div>
          <div className="flex items-center gap-2">
